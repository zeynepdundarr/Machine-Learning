...
exercise benefited from: https://machinelearningmastery.com/calculate-feature-importance-with-python/   
...
X_train_fs, X_test_fs, fs = select_features(X_train_encoded, y_train_encoded, X_test_encoded)
print(X_train[:,:10])
